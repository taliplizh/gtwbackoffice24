        ...
        <table width="100%">
            <tr>
                ...
                <td width="80%">                   
                        ...
                        <label class="form-check-label" for="inlineRadio1">เลขไมล์ระยะทางก่อนออกเดินทาง &nbsp;&nbsp; &nbsp;&nbsp;{{$inforcar->CAR_NUMBER_BEGIN}}</label>
                </td>
            </tr>
            <tr>
                <td width="10%">
                ...
                <td width="90%">
                    ...
                    <label class="form-check-label" for="inlineRadio2">เลขไมล์ระยะทางหลังออกเดินทาง &nbsp;&nbsp; &nbsp;&nbsp;{{$inforcar->CAR_NUMBER_BACK}}</label>
                </td>
            </tr>
        </table>
        <br> <br>

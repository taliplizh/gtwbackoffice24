...
<div class="container-fluid shadow mb-5">
    <div class="row">
        <div class="col-12">
            <br>
            <div class="card">
                <div class="card-header text-center bg-sl-blue py-3 " style="background-color:#<?php echo $color_get; ?>;">
                    <h3 class="fs-24 m-0 text-white fw-3">ข้อมูลบุคลากร{{$status_name->HR_STATUS_NAME}}</h3>
                </div>
                <div class="card-body py-3">
                    <div class="card">
                        <div class="card-header row">
                            ...
                            <p class="col-sm-6 text-paragraph fs-22 text-right pr-5">ข้อมูลวันที่ <span>1 ตุลาคม
                                    พ.ศ.2563 - 30 กันยายน พ.ศ.2564</span></p> -->
                        </div>
                        <div class="card-body">
                            <div class="container-fluit">
                                ...
                                <div class="tab-content d-flex justify-content-center">
                                    <div id="graph" class="container-fluit w-95 tab-pane active"><br>
                                        <div class="panel p-1 "style="background-color:#<?php echo $color_get; ?>;">
                                            ...
                                            <div class="panel-body bg-white" style="overflow-y:hidden">
                                                <div id="columnchart_car"
                                                    style="font-family: 'Kanit', sans-serif;width: 100%; height:500px">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="table" class="container-fluit w-100 tab-pane fade table-responsive"><br>
                                        <table id="NormalWork_table" class="table-striped">
                                            <thead style="background-color:#<?php echo $color_get; ?>;" class=" text-white">
                                                <tr class="">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $person->HR_PREFIX_NAME }}{{ $person -> HR_FNAME }}
                                                        {{ $person -> HR_LNAME }}</td>
                                                    ...
                                                    <td class="text-center">{{ DateThairetire($person -> HR_BIRTHDAY) }}
                                                    </td>
                                                    <td class="text-center">{{getAgeretire($person -> HR_BIRTHDAY) }}
                                                    </td>
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var chart = new google.visualization.ColumnChart(document.getElementById('NormalWork_chart'));
...
<script type="text/javascript">
    ...
    function drawChart3() {
            ...
            ['ตำแหน่ง','จำนวน'],
            <?php $i=0;  $j=0; ?>
            @foreach($name_pos as $row)

            ['<?php echo $name1[$i];?>',<?php echo $data1[$j];?>],

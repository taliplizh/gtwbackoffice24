...
<head>
    ...
    <!-- cdn ทำให้เว็บช้า เลยปิดไว้ เพพราะปกติเทมเพจมี bootstarp และ jquery อยู่แล้ว ไม่จำเป้นต้องเรียกซ้ำ -->
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="link-fx font-size-lg font-w600 text-white" href="">
                        ...
                        <span class="text-white-50"></span><span class="text-white"
                            style="font-weight: normal;font-family: 'Kanit', sans-serif;">บุคลากร</span>
                    </a>
                    <!-- END Logo -->
                        ...
                        <ul class="nav-main nav-main-horizontal nav-main-hover ">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_person/carcalendar') ? ' active' : '' }}"
                                    ...
                                    <span class="nav-main-link-name"
                                        style="font-size: 14px;font-family: 'Kanit', sans-serif;">ปฏิทิน</span>
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_person/inforperson') ? ' active' : '' }}"
                                    ...
                                    <span class="nav-main-link-name"
                                        style="font-size: 14px;font-family: 'Kanit', sans-serif;">ข้อมูลบุคลากร</span>
                            ...
                            <li class="nav-main-item">
                                ...
                                <a class="nav-main-link{{ request()->is('manager_person/persondevreport') ? ' active' : '' }}"
                                    ...
                                    <i class="nav-main-link-icon fa fa-users"></i>
                                    <span class="nav-main-link-name"
                                        style="font-size: 14px;font-family: 'Kanit', sans-serif;">ประชุมอบรมภายนอก</span>
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_person/inforperson_meetinginside') ? ' active' : '' }}"
                                    ...
                                    <i class="nav-main-link-icon fa fa-users"></i>
                                    <span class="nav-main-link-name"
                                        style="font-size: 14px;font-family: 'Kanit', sans-serif;">ประชุมอบรมภายใน</span>
                            ...
                            <li class="nav-main-item">
                                ...
                                <ul class="nav-main-submenu">
                                    ...
                                    <li class="nav-main-item">
                                        <div class="nav-main-item-title">ข้อมูลการทำงาน</div></li>
                                    <li class="nav-main-item">
                                        <div role="separator" class="dropdown-divider"></div>
                                    </li>
                                    <!--
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link {{request()->is('manager_person/setup/infowork/kpi*')?'active':''}}" href="{{ route('mperson.setinfo_kpi') }}">
                                            <i class="nav-main-link-icon fa fa-cog"></i>
                                            <span class="nav-main-link-name">ตัวชี้วัด (KPI)</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link {{request()->is('manager_person/setup/infowork/permission_job*')?'active':''}}" href="{{ route('mperson.permission_job') }}">
                                            <i class="nav-main-link-icon fa fa-cog"></i>
                                            <span class="nav-main-link-name">ตั้งค่าสิทธิ์ประเมิน KPI</span>
                                        </a>
                                    </li>
                                    <!-- <li class="nav-main-item">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_car/report') ? ' active' : '' }}"
                                    ...
                                    <span class="nav-main-link-name"
                                        style="font-size: 14px;font-family: 'Kanit', sans-serif;">รายงาน</span>

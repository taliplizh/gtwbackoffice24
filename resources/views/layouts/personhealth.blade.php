                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <li class="nav-main-item"> 
                                ...
                                <li class="nav-main-item">
                                 ...
                                 <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_person/health-check/main') ? ' active' : '' }}" 
                                        href="/manager_person/health-check/main">
                                        <i class="nav-main-link-icon fa fa-users"></i>
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link nav-main-link-submenu {{request()->is('manager_person/reportinforpersonhealth')?'active':''}}" data-toggle="submenu"
                                        aria-haspopup="true" aria-expanded="false" href="#">
                                        <i class="nav-main-link-icon fa fa-cogs"></i>
                                        <span class="nav-main-link-name">รายการ</span>
                                    </a>
                                    <ul class="nav-main-submenu">
                                        <li class="nav-main-item">
                                            <a class="nav-main-link {{request()->is('manager_person/reportinforpersonhealth')?'active':''}}" 
                                                href="{{ url('manager_person/reportinforpersonhealth') }}">
                                                <span class="nav-main-link-name">รายการสุขภาพ</span>
                                            </a>
                                        </li>
                                        <li class="nav-main-item">
                                            <a class="nav-main-link {{request()->is('manager_person/health-check/report')?'active':''}}" 
                                                href="{{ url('manager_person/health-check/report') }}">
                                                <span class="nav-main-link-name">รายการทดสอบสมรรถภาพ</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>

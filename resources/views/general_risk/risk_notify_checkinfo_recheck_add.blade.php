    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title foo15 text-center" style="font-family: 'Kanit', sans-serif;">
                <B>เพิ่มข้อมูลทบทวนความเสี่ยง</B></h3>
        </div>
        <div class="block-content block-content-full">
            <form action="{{route('gen_risk.risk_notify_checkinfo_recheck_save')}}" method="post" id="form" enctype="multipart/form-data">
                @csrf 
                <input type="hidden" name="iduser" value="{{$iduser}}">
                <input type="hidden" name="RISK_RECHECK_RISKID" value="{{$idrisk}}">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col">
                                วันที่บันทึก {{date('d/m/'.(date('Y')+543).' H:i:s')}}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <textarea name="RISK_RECHECK_DETAIL" id="RISK_RECHECK_DETAIL" rows="3" cols="50"
                                    class="form-control textarea-sm" style=" font-family: 'Kanit', sans-serif;" required></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                ...
                <div class="modal-footer">
                    <div align="right">
                        ...
                        <a href="{{route('gen_risk.risk_notify_checkinfo_recheck',[$idrisk,$iduser])}}"

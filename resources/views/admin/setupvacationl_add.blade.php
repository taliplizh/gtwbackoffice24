...
?>
      ...
      <div class="row push">       
       ...
       <div class="col-lg-2">
        ...
        <div class="col-lg-1">
          <input  name = "DAY_LEAVE_COLLECT"  id="DAY_LEAVE_COLLECT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" required>
        </div>
        <div class="col-lg-1">
          <label >วัน</label>
        </div>
       ...
       <div class="col-lg-1">
       <input  name = "DAY_LEAVE_OVER_BEFORE"  id="DAY_LEAVE_OVER_BEFORE" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" required>
       </div>

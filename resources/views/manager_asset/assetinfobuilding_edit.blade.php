                ...
                <div class="row">
                    <div class="col-md-7" style="text-align: center">
                        ...
                        <div style='overflow:scroll; width:auto;height:900px;  background-color: #404040;' id="pages">
                            ...
                            {{-- <iframe
                                ...
                                <iframe src="{{ asset('storage/app/public/assetpdf/'.$infoassetbuilding->FILE_NAME ) }}" height="100%" width="100%"></iframe>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="BUILD_NAME" id="BUILD_NAME" class="form-control input-sm {{$errors->has('BUILD_NAME') ? 'is-invalid' : '' }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input name="BUILD_NGUD_MONEY" id="BUILD_NGUD_MONEY" class="form-control input-sm {{$errors->has('BUILD_NGUD_MONEY') ? 'is-invalid' : '' }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input name="TOTAL" id="TOTAL" class="form-control input-sm {{$errors->has('TOTAL') ? 'is-invalid' : '' }}"
                            ...
                            <div class="col-md-3">
                                <input name="OLD_USE" id="OLD_USE" class="form-control input-sm {{$errors->has('OLD_USE') ? 'is-invalid' : '' }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="BUILD_HR_TEL" id="BUILD_HR_TEL" class="form-control input-sm {{$errors->has('BUILD_HR_TEL') ? 'is-invalid' : '' }}"
                                    style=" font-family: 'Kanit', sans-serif;"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="ENGINEER_NAME" id="ENGINEER_NAME" class="form-control input-sm {{$errors->has('ENGINEER_NAME') ? 'is-invalid' : '' }}"
                                    style=" font-family: 'Kanit', sans-serif;"
                ...
                <div class="modal-footer">
                    <div align="right">
                        <span type="button" class="btn btn-hero-sm btn-hero-info btn-submit-edit"
                            ><i class="fas fa-save"></i>&nbsp;บันทึกแก้ไขข้อมูล</span>

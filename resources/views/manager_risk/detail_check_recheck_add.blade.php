...
<center>
    ...
    <div class="block" style="width: 95%;">
        <div class="block-header block-header-default">
            <h3 class="block-title" style="font-family: 'Kanit', sans-serif;"><B>ทบทวนข้อมูลความเสี่ยง</B></h3>
        </div>
        <form method="post" action="{{ route('mrisk.detail_check_recheck_save') }}" enctype="multipart/form-data"
            class="needs-validation" novalidate>
            @csrf
            <input type="hidden" name="RISK_RECHECK_RISKID" id="RISK_RECHECK_RISKID" value="{{$riskid}}"
            ...
            <div class="block-content block-content-full">
                <div class="row">
                    <div class="col-md-7" style="text-align: center">
                        ...
                        <a id="zoom-out" class="btn btn-info" style="color:#F0FFFF"><i
                                class="fa fa-search-minus"></i></a>
                        <a id="zoom-reset" class="btn btn-info" style="color:#F0FFFF"><i
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9" style="text-align: left">
                                <select name="RISK_RECHECK_PERSON" id="RISK_RECHECK_PERSON"
                                    ...
                                    <option value="{{ $person -> ID}}">{{ $person->HR_FNAME}} {{ $person->HR_LNAME}}
                                    </option>
                                    @endforeach
                                </select>
                ...
                <div class="modal-footer">
                    <div align="right">
                        ...
                        <a href="{{ url('manager_risk/detail_check_recheck/'.$riskid)  }}"
                        ...
                        <a href="{{ url('manager_book/bookreceipt')  }}" class="btn btn-hero-sm btn-hero-danger"
                        style="font-family:
                        'Kanit', sans-serif;font-weight:normal;" onclick="return
                        confirm('ต้องการที่จะยกเลิกการเพิ่มข้อมูล ?')" ><i class="fas fa-window-close"></i>
                        &nbsp;ยกเลิก</a> --}}
                    </div>
                </div>
            </div>

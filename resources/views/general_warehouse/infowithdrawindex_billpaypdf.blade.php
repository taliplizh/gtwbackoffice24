...
<html>
    ...
    <table style="width: 800px"> 
        <tr>
            ...
            <th style="width: 160px" rowspan="2"><center>รายการ</center></th>
            ...
            <th style="width: 70px" rowspan="2"><center>หมายเหตุ</center></th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 160px; word-break:break-all; word-wrap:break-word" class="text-font text-pedding"> {{ thainumDigit($warehouserequest->SUP_NAME )}}  </td>
    
        <td style="width: 30px; word-break:break-all; word-wrap:break-word;text-align: center" class="text-font text-pedding">{{$warehouserequest->SUP_UNIT_NAME}}</td>           
        ...
        <tr>
            <th style="width: 500px; word-break:break-all; word-wrap:break-word;text-align: right;font-size: 13px;" colspan="6">ราคารวม&nbsp;&nbsp;</th> 
    ...
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label for=""> ( &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$inforwarehouserequests->WAREHOUSE_SAVE_HR_NAME}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        )</label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label for=""> (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="">{{DateThaifrom($inforwarehouserequests->WAREHOUSE_DATE_WANT)}}</label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="">@if($inforwarehouserequests->WAREHOUSE_PAYDAY <> '' && $inforwarehouserequests->WAREHOUSE_PAYDAY <> null){{DateThaifrom($inforwarehouserequests->WAREHOUSE_PAYDAY)}}@endif</label>
